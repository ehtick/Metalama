...
namespace Metalama.Framework.DesignTime.Pipeline.Diff
{
	public class RunTimeCodeHasher : BaseCodeHasher
	{
		...
		public override void VisitAnonymousMethodExpression( AnonymousMethodExpressionSyntax node )
		{
			...
			this.VisitTrivialToken( node.DelegateKeyword );
			this.Visit( node.ParameterList );
			// Skipping content of Block because it is irrelevant at design time for non-compile-time code.
			this.HashValue( node.Block is null );
		...
		public override void VisitLocalFunctionStatement( LocalFunctionStatementSyntax node )
		{
			...
			// Skipping content of Body because it is irrelevant at design time for non-compile-time code.
			this.HashValue( node.Body is null );
			// Skipping content of ExpressionBody because it is irrelevant at design time for non-compile-time code.
			this.HashValue( node.ExpressionBody is null );
		...
		public override void VisitVariableDeclarator( VariableDeclaratorSyntax node )
		{
			this.VisitNonTrivialToken( node.Identifier );
			this.Visit( node.ArgumentList );
			// Skipping content of Initializer because it is irrelevant at design time for non-compile-time code.
			this.HashValue( node.Initializer is null );
		}
		[ExcludeFromCodeCoverage]
		...
		public override void VisitUsingDirective( UsingDirectiveSyntax node )
		{
			...
			this.VisitTrivialToken( node.UsingKeyword );
			this.Visit( node.NamespaceOrType );
			this.VisitTrivialToken( node.SemicolonToken );
		...
		public override void VisitEnumMemberDeclaration( EnumMemberDeclarationSyntax node )
		{
			...
			this.Visit( node.Modifiers );
			this.VisitNonTrivialToken( node.Identifier );
			// Skipping content of EqualsValue because it is irrelevant at design time for non-compile-time code.
			this.HashValue( node.EqualsValue is null );
		}
		[ExcludeFromCodeCoverage]
		...
		{
			this.VisitTrivialToken( node.AllowsKeyword );
			this.Visit( node.Constraints );
		}
		[ExcludeFromCodeCoverage]
		...
		{
			this.VisitTrivialToken( node.RefKeyword );
			this.VisitTrivialToken( node.StructKeyword );
		}
		[ExcludeFromCodeCoverage]
		...
		public override void VisitParameter( ParameterSyntax node )
		{
			...
			this.Visit( node.Type );
			this.VisitNonTrivialToken( node.Identifier );
			// Skipping content of Default because it is irrelevant at design time for non-compile-time code.
			this.HashValue( node.Default is null );
		}
		[ExcludeFromCodeCoverage]
