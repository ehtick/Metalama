...
partial class MetaSyntaxRewriter
{
	...
	public override SyntaxNode? VisitScopedType( ScopedTypeSyntax node )
	{
		...
		{
			case TransformationKind.Transform:
				return this.TransformScopedType( node );
			default:
	...
	public override SyntaxNode? VisitCollectionExpression( CollectionExpressionSyntax node )
	{
		...
		{
			case TransformationKind.Transform:
				return this.TransformCollectionExpression( node );
			default:
				return base.VisitCollectionExpression( node );
		}
	}
	[ExcludeFromCodeCoverage]
	protected virtual ExpressionSyntax TransformCollectionExpression( CollectionExpressionSyntax node )
	{
		this.Indent();
		ExpressionSyntax result;
	...
	public override SyntaxNode? VisitExpressionElement( ExpressionElementSyntax node )
	{
		...
		{
			case TransformationKind.Transform:
				return this.TransformExpressionElement( node );
			default:
				return base.VisitExpressionElement( node );
		}
	}
	[ExcludeFromCodeCoverage]
	protected virtual ExpressionSyntax TransformExpressionElement( ExpressionElementSyntax node )
	{
		this.Indent();
		ExpressionSyntax result;
	...
	[ExcludeFromCodeCoverage]
	protected virtual ExpressionSyntax TransformSpreadElement( SpreadElementSyntax node )
	{
		this.Indent();
		ExpressionSyntax result;
	...
	public override SyntaxNode? VisitListPattern( ListPatternSyntax node )
	{
		...
		{
			case TransformationKind.Transform:
				return this.TransformListPattern( node );
			default:
	...
	public override SyntaxNode? VisitSlicePattern( SlicePatternSyntax node )
	{
		...
		{
			case TransformationKind.Transform:
				return this.TransformSlicePattern( node );
			default:
	...
	public override SyntaxNode? VisitAllowsConstraintClause( AllowsConstraintClauseSyntax node )
	{
		...
		{
			case TransformationKind.Transform:
				return this.TransformAllowsConstraintClause( node );
			default:
				return base.VisitAllowsConstraintClause( node );
		}
	}
	[ExcludeFromCodeCoverage]
	protected virtual ExpressionSyntax TransformAllowsConstraintClause( AllowsConstraintClauseSyntax node )
	{
		this.Indent();
		ExpressionSyntax result;
		result = InvocationExpression(this.MetaSyntaxFactory.SyntaxFactoryMethod(nameof(AllowsConstraintClause))).WithArgumentList(ArgumentList(SeparatedList<ArgumentSyntax>(new SyntaxNodeOrToken[]{
			Argument(this.Transform(node.AllowsKeyword)).WithOptionalLeadingTrivia(this.GetIndentation(), this._generationOptions),
			Token(SyntaxKind.CommaToken).WithOptionalTrailingTrivia(GetLineBreak(), this._generationOptions),
			Argument(this.Transform(node.Constraints)).WithOptionalLeadingTrivia(this.GetIndentation(), this._generationOptions),
		})));
		this.Unindent();
	...
	public override SyntaxNode? VisitRefStructConstraint( RefStructConstraintSyntax node )
	{
		...
		{
			case TransformationKind.Transform:
				return this.TransformRefStructConstraint( node );
			default:
				return base.VisitRefStructConstraint( node );
		}
	}
	[ExcludeFromCodeCoverage]
	protected virtual ExpressionSyntax TransformRefStructConstraint( RefStructConstraintSyntax node )
	{
		this.Indent();
		ExpressionSyntax result;
		result = InvocationExpression(this.MetaSyntaxFactory.SyntaxFactoryMethod(nameof(RefStructConstraint))).WithArgumentList(ArgumentList(SeparatedList<ArgumentSyntax>(new SyntaxNodeOrToken[]{
			Argument(this.Transform(node.RefKeyword)).WithOptionalLeadingTrivia(this.GetIndentation(), this._generationOptions),
			Token(SyntaxKind.CommaToken).WithOptionalTrailingTrivia(GetLineBreak(), this._generationOptions),
			Argument(this.Transform(node.StructKeyword)).WithOptionalLeadingTrivia(this.GetIndentation(), this._generationOptions),
		})));
		this.Unindent();
		return result;
	}
	...
	partial class MetaSyntaxFactoryImpl
	{
		...
		public InvocationExpressionSyntax ScopedType(ExpressionSyntax scopedKeyword, ExpressionSyntax type)
			=> SyntaxFactory.InvocationExpression( this.SyntaxFactoryMethod( "ScopedType" ), SyntaxFactory.ArgumentList(SyntaxFactory.SeparatedList<ArgumentSyntax>( new ArgumentSyntax[]{
					SyntaxFactory.Argument( scopedKeyword ), 
					SyntaxFactory.Argument( type )})));
		...
		[ExcludeFromCodeCoverage]
		public InvocationExpressionSyntax CollectionExpression(ExpressionSyntax openBracketToken, ExpressionSyntax elements, ExpressionSyntax closeBracketToken)
			=> SyntaxFactory.InvocationExpression( this.SyntaxFactoryMethod( "CollectionExpression" ), SyntaxFactory.ArgumentList(SyntaxFactory.SeparatedList<ArgumentSyntax>( new ArgumentSyntax[]{
					SyntaxFactory.Argument( openBracketToken ), 
					SyntaxFactory.Argument( elements ), 
					SyntaxFactory.Argument( closeBracketToken )})));

		[ExcludeFromCodeCoverage]
		public InvocationExpressionSyntax CollectionExpression(ExpressionSyntax elements)
			=> SyntaxFactory.InvocationExpression( this.SyntaxFactoryMethod( "CollectionExpression" ), SyntaxFactory.ArgumentList(SyntaxFactory.SeparatedList<ArgumentSyntax>( new ArgumentSyntax[]{
					SyntaxFactory.Argument( elements )})));

		[ExcludeFromCodeCoverage]
		public InvocationExpressionSyntax ExpressionElement(ExpressionSyntax expression)
			=> SyntaxFactory.InvocationExpression( this.SyntaxFactoryMethod( "ExpressionElement" ), SyntaxFactory.ArgumentList(SyntaxFactory.SeparatedList<ArgumentSyntax>( new ArgumentSyntax[]{
					SyntaxFactory.Argument( expression )})));

		[ExcludeFromCodeCoverage]
		public InvocationExpressionSyntax SpreadElement(ExpressionSyntax operatorToken, ExpressionSyntax expression)
			=> SyntaxFactory.InvocationExpression( this.SyntaxFactoryMethod( "SpreadElement" ), SyntaxFactory.ArgumentList(SyntaxFactory.SeparatedList<ArgumentSyntax>( new ArgumentSyntax[]{
					SyntaxFactory.Argument( operatorToken ), 
					SyntaxFactory.Argument( expression )})));

		[ExcludeFromCodeCoverage]
		public InvocationExpressionSyntax SpreadElement(ExpressionSyntax expression)
			=> SyntaxFactory.InvocationExpression( this.SyntaxFactoryMethod( "SpreadElement" ), SyntaxFactory.ArgumentList(SyntaxFactory.SeparatedList<ArgumentSyntax>( new ArgumentSyntax[]{
					SyntaxFactory.Argument( expression )})));
		...
		public InvocationExpressionSyntax ListPattern(ExpressionSyntax openBracketToken, ExpressionSyntax patterns, ExpressionSyntax closeBracketToken, ExpressionSyntax designation)
			=> SyntaxFactory.InvocationExpression( this.SyntaxFactoryMethod( "ListPattern" ), SyntaxFactory.ArgumentList(SyntaxFactory.SeparatedList<ArgumentSyntax>( new ArgumentSyntax[]{
					SyntaxFactory.Argument( openBracketToken ), 
					SyntaxFactory.Argument( patterns ), 
					SyntaxFactory.Argument( closeBracketToken ), 
					SyntaxFactory.Argument( designation )})));
		...
		public InvocationExpressionSyntax SlicePattern(ExpressionSyntax dotDotToken, ExpressionSyntax pattern)
			=> SyntaxFactory.InvocationExpression( this.SyntaxFactoryMethod( "SlicePattern" ), SyntaxFactory.ArgumentList(SyntaxFactory.SeparatedList<ArgumentSyntax>( new ArgumentSyntax[]{
					SyntaxFactory.Argument( dotDotToken ), 
					SyntaxFactory.Argument( pattern )})));
		...
		[ExcludeFromCodeCoverage]
		public InvocationExpressionSyntax UsingDirective(ExpressionSyntax globalKeyword, ExpressionSyntax usingKeyword, ExpressionSyntax staticKeyword, ExpressionSyntax unsafeKeyword, ExpressionSyntax alias, ExpressionSyntax namespaceOrType, ExpressionSyntax semicolonToken)
			=> SyntaxFactory.InvocationExpression( this.SyntaxFactoryMethod( "UsingDirective" ), SyntaxFactory.ArgumentList(SyntaxFactory.SeparatedList<ArgumentSyntax>( new ArgumentSyntax[]{
					...
					SyntaxFactory.Argument( unsafeKeyword ), 
					SyntaxFactory.Argument( alias ), 
					SyntaxFactory.Argument( namespaceOrType ), 
					SyntaxFactory.Argument( semicolonToken )})));

		[ExcludeFromCodeCoverage]
		public InvocationExpressionSyntax UsingDirective(ExpressionSyntax alias, ExpressionSyntax namespaceOrType)
			=> SyntaxFactory.InvocationExpression( this.SyntaxFactoryMethod( "UsingDirective" ), SyntaxFactory.ArgumentList(SyntaxFactory.SeparatedList<ArgumentSyntax>( new ArgumentSyntax[]{
					SyntaxFactory.Argument( alias ), 
					SyntaxFactory.Argument( namespaceOrType )})));
		...
		[ExcludeFromCodeCoverage]
		public InvocationExpressionSyntax ClassDeclaration(ExpressionSyntax attributeLists, ExpressionSyntax modifiers, ExpressionSyntax identifier, ExpressionSyntax typeParameterList, ExpressionSyntax parameterList, ExpressionSyntax baseList, ExpressionSyntax constraintClauses, ExpressionSyntax members)
			=> SyntaxFactory.InvocationExpression( this.SyntaxFactoryMethod( "ClassDeclaration" ), SyntaxFactory.ArgumentList(SyntaxFactory.SeparatedList<ArgumentSyntax>( new ArgumentSyntax[]{
					SyntaxFactory.Argument( attributeLists ), 
					SyntaxFactory.Argument( modifiers ), 
					SyntaxFactory.Argument( identifier ), 
		...
		[ExcludeFromCodeCoverage]
		public InvocationExpressionSyntax StructDeclaration(ExpressionSyntax attributeLists, ExpressionSyntax modifiers, ExpressionSyntax identifier, ExpressionSyntax typeParameterList, ExpressionSyntax parameterList, ExpressionSyntax baseList, ExpressionSyntax constraintClauses, ExpressionSyntax members)
			=> SyntaxFactory.InvocationExpression( this.SyntaxFactoryMethod( "StructDeclaration" ), SyntaxFactory.ArgumentList(SyntaxFactory.SeparatedList<ArgumentSyntax>( new ArgumentSyntax[]{
					SyntaxFactory.Argument( attributeLists ), 
					SyntaxFactory.Argument( modifiers ), 
					SyntaxFactory.Argument( identifier ), 
		...
		[ExcludeFromCodeCoverage]
		public InvocationExpressionSyntax InterfaceDeclaration(ExpressionSyntax attributeLists, ExpressionSyntax modifiers, ExpressionSyntax identifier, ExpressionSyntax typeParameterList, ExpressionSyntax parameterList, ExpressionSyntax baseList, ExpressionSyntax constraintClauses, ExpressionSyntax members)
			=> SyntaxFactory.InvocationExpression( this.SyntaxFactoryMethod( "InterfaceDeclaration" ), SyntaxFactory.ArgumentList(SyntaxFactory.SeparatedList<ArgumentSyntax>( new ArgumentSyntax[]{
					SyntaxFactory.Argument( attributeLists ), 
					SyntaxFactory.Argument( modifiers ), 
					SyntaxFactory.Argument( identifier ), 
		...
		[ExcludeFromCodeCoverage]
		public InvocationExpressionSyntax AllowsConstraintClause(ExpressionSyntax allowsKeyword, ExpressionSyntax constraints)
			=> SyntaxFactory.InvocationExpression( this.SyntaxFactoryMethod( "AllowsConstraintClause" ), SyntaxFactory.ArgumentList(SyntaxFactory.SeparatedList<ArgumentSyntax>( new ArgumentSyntax[]{
					SyntaxFactory.Argument( allowsKeyword ), 
					SyntaxFactory.Argument( constraints )})));

		[ExcludeFromCodeCoverage]
		public InvocationExpressionSyntax AllowsConstraintClause(ExpressionSyntax constraints)
			=> SyntaxFactory.InvocationExpression( this.SyntaxFactoryMethod( "AllowsConstraintClause" ), SyntaxFactory.ArgumentList(SyntaxFactory.SeparatedList<ArgumentSyntax>( new ArgumentSyntax[]{
					SyntaxFactory.Argument( constraints )})));

		[ExcludeFromCodeCoverage]
		public InvocationExpressionSyntax RefStructConstraint(ExpressionSyntax refKeyword, ExpressionSyntax structKeyword)
			=> SyntaxFactory.InvocationExpression( this.SyntaxFactoryMethod( "RefStructConstraint" ), SyntaxFactory.ArgumentList(SyntaxFactory.SeparatedList<ArgumentSyntax>( new ArgumentSyntax[]{
					SyntaxFactory.Argument( refKeyword ), 
					SyntaxFactory.Argument( structKeyword )})));

		[ExcludeFromCodeCoverage]
		public InvocationExpressionSyntax RefStructConstraint()
			=> SyntaxFactory.InvocationExpression( this.SyntaxFactoryMethod( "RefStructConstraint" ), SyntaxFactory.ArgumentList(SyntaxFactory.SeparatedList<ArgumentSyntax>()));
		...
		public InvocationExpressionSyntax OperatorDeclaration(ExpressionSyntax attributeLists, ExpressionSyntax modifiers, ExpressionSyntax returnType, ExpressionSyntax explicitInterfaceSpecifier, ExpressionSyntax operatorKeyword, ExpressionSyntax checkedKeyword, ExpressionSyntax operatorToken, ExpressionSyntax parameterList, ExpressionSyntax body, ExpressionSyntax expressionBody, ExpressionSyntax semicolonToken)
			=> SyntaxFactory.InvocationExpression( this.SyntaxFactoryMethod( "OperatorDeclaration" ), SyntaxFactory.ArgumentList(SyntaxFactory.SeparatedList<ArgumentSyntax>( new ArgumentSyntax[]{
					...
					SyntaxFactory.Argument( checkedKeyword ), 
					SyntaxFactory.Argument( operatorToken ), 
					SyntaxFactory.Argument( parameterList ), 
					SyntaxFactory.Argument( body ), 
					SyntaxFactory.Argument( expressionBody ), 
		...
		[ExcludeFromCodeCoverage]
		public InvocationExpressionSyntax CrefParameter(ExpressionSyntax refKindKeyword, ExpressionSyntax readOnlyKeyword, ExpressionSyntax type)
